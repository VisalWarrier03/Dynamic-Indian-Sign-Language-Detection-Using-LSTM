...
FEATURE_DIM = 225
MODEL_PATH = r"C:\Users\visha\OneDrive\Desktop\U21CS010\VII Semester\Deep Learning HW\ISL Test\adjectives_lstm_model_17_best.keras"
OUTPUT_PATH = os.path.join(os.path.expanduser("~"), "Desktop", "isl_prediction_output_17_2.avi")
...
class RealTimePredictor:
    ...
    def get_top_5_predictions(self, features):
        ...
        # Print high confidence predictions to terminal
    ...
    def process_video(self, video_path):
        ...
        frame_time = int(1000 / fps)  # Default frame time in milliseconds
        ...
        while cap.isOpened():
            ...
            cv2.imshow('Real-time ISL Recognition', annotated_frame)
